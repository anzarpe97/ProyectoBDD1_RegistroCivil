...
def actaDefuncion ():
    ...
    FMuerteLabel.place (x = 90, y = 130)

    FMuerteEntry = tk.Entry(frameInicio, relief = "flat")
    FMuerteEntry.place (x = 260, y = 133)
    ...
    FormatoMuLabel.place (x = 262, y = 157)
    ...
    LMuerteLabel.place (x = 90, y = 180)

    LMuerteEntry = tk.Entry(frameInicio, relief = "flat")
    LMuerteEntry.place (x = 260, y = 183)
